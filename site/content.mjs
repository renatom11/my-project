...
export const documents = [
  { group: 'Specifications', items: [
    { src: 'docs/specs/REQUIREMENTS-LIST.md', slug: 'requirements-list', title: 'Flat requirement list — WITHDRAWN', status: 'withdrawn',
      blurb: 'Withdrawn on AUD-0003 F1 (CRITICAL). It was generated by extracting requirement text from the specification; for three requirements it stated something that was not the requirement, and for 57 of 91 it was not a requirement statement at all. Kept as a record of the withdrawal.' },
